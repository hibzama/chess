...
export default function JoinAllPage() {
    const WHATSAPP_GROUP_LINK = "https://chat.whatsapp.com/G2ICy8LcCzs8CM67Z9b5xe?mode=ac_t";
        ...
        <div className="relative flex items-center justify-center min-h-screen w-full bg-background text-white p-4">
            ...
            <Card className="w-full max-w-md z-20 text-center bg-card/50 border-primary/30 animate-in fade-in-50 zoom-in-95">
                <CardHeader>
                    ...
                    <CardDescription className="text-lg text-muted-foreground pt-2">Join the Global Nexbattle Community</CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                    <p className="text-foreground/90">
                        You've found the global hub for the world's most competitive minds. Join our official WhatsApp group to find opponents, discuss strategy, and be the first to know about exclusive international tournaments and rewards.
                    </p>
