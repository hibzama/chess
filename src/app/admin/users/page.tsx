...
export default function UsersPage() {
    ...
    const handleLoginAsUser = async (uid: string) => {
        ...
        try {
            // In a real production app, this token would be generated by a secure backend Cloud Function.
            // For this environment, we simulate a backend call.
            ...
            // Store original admin ID to allow "login back" functionality
