...
import { LayoutGrid, Users, LogOut, Clock, History, DollarSign, ArrowUpCircle, ArrowDownCircle, Megaphone, Wallet, Swords, Fingerprint, ShieldAlert, Mail, Settings, Gift, PercentCircle, CalendarClock, Award, CheckSquare, ClipboardCheck, Coins, Rule } from "lucide-react";
                    ...
                    <SidebarMenu>
                        ...
                        <SidebarMenuItem>
                         ...
                         <SidebarMenuItem>
                            ...
                            <Link href="/admin/settings/game-rules"><SidebarMenuButton tooltip="Game Rules" isActive={isActive('/admin/settings/game-rules')}><Rule /><span>Game Rules</span></SidebarMenuButton></Link>
