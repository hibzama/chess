...
import { Home, LayoutGrid, BarChart3, Users, Swords, Trophy, Megaphone, MessageSquare, Info, Settings, LifeBuoy, Wallet, Bell, User, LogOut, Gamepad2, Circle, Phone, Mail, List, Calendar } from "lucide-react";
                    ...
                    <SidebarMenu>
                        {isMarketer ? (
                            ...
                            <>
                                ...
                                <SidebarMenuItem>
                                    <Link href="/dashboard/events"><SidebarMenuButton tooltip="Events" isActive={isMounted && pathname.startsWith('/dashboard/events')}><Calendar /><span>Events</span></SidebarMenuButton></Link>
                                </SidebarMenuItem>
                                <SidebarMenuItem>
