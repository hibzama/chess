...
exports.announceNewGame = functions.firestore
    ...
    const createdBy = ((_a = roomData.createdBy) === null || _a === void 0 ? void 0 : _a.name) || "A Player";
    const message = `⚔️ New Public ${gameType} Room! ⚔️\n\n` +
        `Player: ${createdBy}\n` +
        `Wager: LKR ${wager.toFixed(2)}\n\n` +
        `Click to join and play!`;
    const telegramApiUrl = `https://api.telegram.org/bot${telegramBotToken}/sendMessage`;
    try {
        await axios_1.default.post(telegramApiUrl, {
            chat_id: chatId,
            text: message,
        });
